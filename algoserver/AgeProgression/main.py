...
if __name__ == '__main__':
    ...
    parser.add_argument('--batch-size', '--bs', dest='batch_size', default=16, type=int)
    parser.add_argument('--weight-decay', '--wd', dest='weight_decay', default=1e-5, type=float)
    parser.add_argument('--learning-rate', '--lr', dest='learning_rate', default=8e-4, type=float)
    ...
    parser.add_argument('--load', '-l', default='./AsianFourResult/epoch11', help='Trained models path for pre-training or for testing')
    # parser.add_argument('--load', '-l', default=None, help='Trained models path for pre-training or for testing')

    parser.add_argument('--input', '-i', default="E:/testdir/20200618185058.jpg", help='Training dataset path (default is {}) or testing image path'.format(default_train_results_dir()))
    parser.add_argument('--output', '-o', default='./AsianOneResult')
