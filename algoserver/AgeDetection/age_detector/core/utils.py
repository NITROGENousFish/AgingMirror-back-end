...
import math
import time
from age_detector.core.data import inputs, standardize_image
import numpy as np
import tensorflow as tf

import re
from age_detector.core.dlibdetect import FaceDetectorDlib
...
def face_detect(id):
    return FaceDetectorDlib('age_detector/core/shape_predictor_68_face_landmarks.dat', id)
